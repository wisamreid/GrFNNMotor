function [X,FVAL,EXITFLAG] = simannealingSB(FUN,X,varargin)
...
%        OPTIONS.highboundslowbounds: vector containing upper bounds for parameters
...
% GLOBAL VARIABLES
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
global ndim nfunk Xguess lowbounds highbounds Temp ybest pbest tempstart

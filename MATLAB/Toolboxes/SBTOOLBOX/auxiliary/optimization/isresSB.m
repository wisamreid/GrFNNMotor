function [X,FVAL,EXITFLAG] = isresSB(FUN,X,varargin)
...
% USAGE:
% ======
% [X,FVAL,EXITFLAG] = isresSBPD(FUN,X)
% [X,FVAL,EXITFLAG] = isresSBPD(FUN,X,OPTIONS)
%
...
for g=1:maxgen,
    ...
    % Selection using stochastic ranking (see isrsort.c)
    I = isrsort(f,phi,pf);

...
saddle_point = 0;
%in the loop the values in the Hopf point are put into saddle_point
for k = 1:gds.dim
...
% ntst = gds.discretization.ntst;
% ncol = gds.discretization.ncol;
...
%         tspan = linspace(gds.time{1,2},(gds.time{1,2}-interval),ntst*ncol+1);

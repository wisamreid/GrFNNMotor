function [tout,yout,iout,vnew,stop] = integDOzero(ntrpfun,v,t,y,tnew,ynew,t0,varargin)
...
yL = y;
vL = v;
vnew = feval(gds.poincare_eq,tnew,ynew,gds.parameters{:,2});
isterminal = 0;
direction = gds.integrator.nr_crossection;
...
while 1
  ...
  while 1
    ...
    vtry = feval(gds.poincare_eq,ttry,ytry,gds.parameters{:,2});
  ...
  elseif abs(tnew - tR) <= tol
    ...
    vL = feval(gds.poincare_eq,tL,yL,gds.parameters{:,2});
